<x-app-layout>
	<div id="loading" class="py-12 px-12 sm:px-6 lg:px-12 " style="background-image: url('{{ asset('img/bg.jpg')}}'); height: 66vh">>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="h2 p-6 text-gray-900 dark:text-gray-100 text-right" >
                    {{ __("اهـــــــــــــــــلا وسـهـــــــــــــــــــــلا") }}
                </div>
            </div>
        </div>
    </div>
    		<!-- Start Schedule Area -->
		<section class="schedule" dir="rtl">
			<div class="container">
						...
						<div class="col-lg-4 col-md-6 col-12 ">
							...
							<a href="{{ route('home.index') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
								<div>
									...
									<h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">المخصصات</h2>
									
									<p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
										مخصصات الاطفال والزوجية
									</p>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-12">
							...
							<a href="{{ route('dashboard') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
								<div>
									...
									<h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">المجمل</h2>
									
									<p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
										مجحمل بيانات افراد العتبة الحسينية
									</p>
								</div>
						...
						<div class="col-lg-4 col-md-12 col-12">
							...
							<a href="{{ route('dashboard') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
								<div>
									...
									<h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">الاضابير</h2>
