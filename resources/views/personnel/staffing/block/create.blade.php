                            ...
                            <tbody>
                                <tr class="text-right">
                                    <td scope="row" class="max-w-3xl mx-auto sm:px-6 lg:px-4 table-secondary" >
                                        <x-text-input id="causes" placeholder="اكتب هنا ...." class="block mt-1 w-full" type="text" name="causes" :value="old('causes')" required autofocus autocomplete="" />
                                    </td>
                            </tbody>
                        </table>
